...
$(document).ready(function() {
  var tabla = $('#asignaturas').DataTable({
            ...
            '<div class="form-group">' +
              ...
              '<div class="input-group">' +
                '<span class="input-group-addon">' +
                  '<i class="glyphicon glyphicon-tag"></i>' +
                '</span>' +
                '<input type="number" id="numero_alumno" class="form-control" placeholder="Numero de alumnos" required>' +
              '</div>' +
            '</div>',
            buttons: {
              cancel: {
              ...
              ok: {
                ...
                callback: function(e) {
                  ...
                  tabla.row.add({
                    ...
                    "numero_alumnos": $('#numero_alumno').val()
                  }).draw();
    ...
    columns: [
      ...
      {data: 'numero_alumnos' , title: 'Alumnos'}, // en esta parte selecciona la respuesta del json y lo carga
      {
  ...
  function btnEditarEvent() {
    ...
    numero_alumnos = asignatura.numero_alumnos
    ;
      ...
      '<div class="form-group">' +
        '<div class="input-group">' +
          ...
          '<span class="input-group-addon">' +
            '<i class="glyphicon glyphicon-tag"></i>' +
          '</span>' +
          '<input type="number" id="editar_alumnos" class="form-control" value="' + numero_alumnos + '" placeholder="Numero de Alumnos">' +
        '</div>' +
      '</div>',
      buttons: {
        cancel: {
          ...
          callback: function(e) {
            ...
            $.ajax({
              ...
              data: {
                ...
                numero_alumnos: $('#editar_alumnos').val()
              }
            })
            .fail(function(err) {
